  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        name: "Go-Sekai Database",
        orientation: "any",
        scope: "https://go-sekai.pages.dev/",
        short_name: "Go-Sekai Database",
        start_url: "https://go-sekai.pages.dev/",
        theme_color: "#298a7b",
      },
      srcDir: "src",
  ...
  server: {
    ...
    proxy: {
      ...
      "/strapi/sekai-current-event": {
        ...
        target: "https://import.meta.env.VITE_STRAPI_BASE",
      },
      "/strapi": {
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/strapi/, ""),
